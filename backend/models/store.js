// Passwords are pre-hashed (bcrypt cost 10) to avoid slow cold starts on Vercel
// All demo users have password: demo123
// Generated with: bcrypt.hashSync('demo123', 10)
const DEMO_HASH = '$2a$10$K44pSE2dgFzDnujBUgpaWusft4zvouUyaUFf/H.aW93/BDbsclLnS';

export const db = {
  users: [
    { id:'u1', name:'Arjun Sharma', email:'employee@demo.com', password:DEMO_HASH, role:'employee', managerId:'u2', department:'Engineering' },
    { id:'u2', name:'Priya Mehta',  email:'manager@demo.com',  password:DEMO_HASH, role:'manager',  managerId:'u3', department:'Engineering' },
    { id:'u3', name:'Ravi Nair',    email:'admin@demo.com',    password:DEMO_HASH, role:'admin',    managerId:null, department:'HR' },
    { id:'u4', name:'Sneha Patel',  email:'sneha@demo.com',    password:DEMO_HASH, role:'employee', managerId:'u2', department:'Engineering' },
    { id:'u5', name:'Karan Verma',  email:'karan@demo.com',    password:DEMO_HASH, role:'employee', managerId:'u2', department:'Engineering' },
  ],

  goals: [
    {
      id:'g1', userId:'u1', title:'Increase API response time efficiency',
      description:'Reduce average API response time by 40% through query optimization and caching.',
      ...
      checkInComments: { q1:'Good progress', q2:'Ahead of target', q3:'', q4:'' },
    },
    {
      ...
      checkInComments: { q1:'', q2:'Enrolled in course', q3:'', q4:'' },
    },
    {
      ...
      checkInComments: { q1:'Clean quarter', q2:'One minor incident', q3:'', q4:'' },
    },
    {
      ...
      checkInStatus:   { q1:'Completed', q2:'On Track', q3:'Not Started', q4:'Not Started' },
      checkInComments: { q1:'', q2:'Slightly over - team expanding', q3:'', q4:'' },
    },
    {
    ...
    },
    {
      ...
      description:'Finish advanced system design program.',
    ...
    },
    {
      ...
      checkInComments: { q1:'', q2:'Both engineers progressing well', q3:'', q4:'' },
    },
  ],
